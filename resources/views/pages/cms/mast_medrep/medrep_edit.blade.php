                                        ...
                                        <div class="col-sm-12 col-xs-12 col-md-6">
                                            ...
                                            <div class="p-20">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="alamat" autocomplete="off" required  value="{{$medrep->alamat}}"  type="text" placeholder="Masukan Alamat" name" class="form-control" id="alamat">
                                                </div>
                                                <div class="form-group">
                                                    <label for="telp">Telepon<span class="text-danger">*</span></label>
                                                    <input name="telp" autocomplete="off" required  value="{{$medrep->telp}}"  type="text" placeholder="Masukan Alamat" name" class="form-control" id="telp">
                                                </div>
                                                <div class="form-group">
