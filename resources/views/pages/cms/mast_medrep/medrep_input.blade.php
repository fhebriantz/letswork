                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="card-box">
                                                ...
                                                @endif
                                                <form method="POST" action="{{url('/medrep/input')}}" data-parsley-validate novalidate>
                                                {{ csrf_field() }}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <div class="input-group">
                                                            <input type="text" autocomplete="off" class="form-control" name="tgl_lahir" placeholder="yyyy-mm-dd" id="tgl_lahir">
