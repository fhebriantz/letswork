                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="card-box">
                                                ...
                                                @endif
                                                <form method="POST" action="{{url('/promo/input')}}" data-parsley-validate novalidate>
                                                {{ csrf_field() }}
                                        ...
                                        <div class="col-sm-12 col-xs-12 col-md-6">
                                            ...
                                            <div class="p-20">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="promo_code"  required  value="{{ old('promo_code') }}"  type="text"  class="form-control" id="promo_code">
                                                </div>
                                                <div class="form-group">
                                                    <label for="promo_name">Nama Promo<span class="text-danger">*</span></label>
                                                    <input name="promo_name"  required  value="{{ old('promo_name') }}"  type="text"  class="form-control" id="promo_name">
                                                </div>
                                                <div class="form-group">
                                                    <label>Nominal</label>
                                                    <input name="nominal" type="text" value="{{ old('nominal') }}" placeholder="Enter only number" data-parsley-type="number" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" id="daterange" name="daterange" autocomplete="off" value="{{ old('daterange') }}" readonly="" />
                                                    </div>
                                                </div>
                                            </div>
