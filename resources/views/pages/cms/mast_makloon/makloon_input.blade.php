                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="card-box">
                                                ...
                                                @endif
                                                <form method="POST" action="{{url('/makloon/input')}}" data-parsley-validate novalidate>
                                                {{ csrf_field() }}
                                        ...
                                        <div class="col-sm-12 col-xs-12 col-md-6">
                                            ...
                                            <div class="p-20">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="merk" autocomplete="off" required    type="text" placeholder="Masukan Merk" name" class="form-control" id="merk">
                                                </div>
                                                <div class="form-group">
                                                    <label for="tahun_makloon">Tahun Makloon<span class="text-danger">*</span></label>
                                                    <input name="tahun_makloon" autocomplete="off" required    type="text" placeholder="Masukan Tahun Makloon" name" class="form-control" id="tahun_makloon">
                                                </div>
                                                <div class="form-group">
                                                    <label for="nama_produk">Nama Produk<span class="text-danger">*</span></label>
                                                    <input name="nama_produk" autocomplete="off" required   type="text" placeholder="Masukan Nama Produk" name" class="form-control" id="nama_produk">
                                                </div>
                                                <div class="form-group">
                                                    <label>Riwayat Pengambilan</label>
                                                    <textarea name="riwayat_pengambilan"  class="form-control" name="" id="" cols="30" rows="5"></textarea>
                                                </div>
                                                 <div class="form-group">
                                                    <label for="stok">Stok<span class="text-danger">*</span></label>
                                                    <input name="stok"  max="99999" autocomplete="off" required    type="number" placeholder="Masukan Stok" name" class="form-control" id="stok">
                                                </div>
