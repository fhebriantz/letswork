                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Master Trans List</h4>
                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>             
                                            ...
                                            <tr>
                                                <td>{{$no++}}</td>
                                                <td><a href="{{url('transaksi/'.$order->id.'/view')}}">{{$order->id_trans_order}}</a></td>
                                                <td>{{$order->nama_dokter}}</a></td>
                                                <td>{{$order->status_name}}</a></td>
                                                <td>
                                                    <a class="btn btn-action marginright btn-pencil-list" href="{{url('transaksi/'.$order->id.'/view')}}"><img class="pencil-list" src="{{ asset('images/icon/pencil.png')}}" alt="" ></a>
                                                    <form method="POST" style="display: inline-block;" action="{{url('/transaksi/'.$order->id.'/delete')}}">
                                                    {{ csrf_field() }}
