                                        ...
                                        <div class="col-sm-12 col-xs-12 col-md-6">
                                            ...
                                            <div class="p-20">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="kemasan" readonly="" value="{{$detail->kemasan}}"  autocomplete="off"     type="text" placeholder="Masukan Kemasan" name" class="form-control" id="kemasan">
                                                </div>
                                                <div class="form-group">
                                                    <label for="qty">Jumlah<span class="text-danger">*</span></label>
                                                    <input name="qty" readonly="" value="{{$detail->qty}}" autocomplete="off"     type="number" max="99999" placeholder="Masukan Jumlah" name" class="form-control" id="qty">
                                                </div>
                                                <div class="form-group">
                                                    <label for="ukuran">Ukuran<span class="text-danger">*</span></label>
                                                    <input name="ukuran" readonly="" value="{{$detail->ukuran}}" autocomplete="off"  type="text" placeholder="Masukan Ukuran" name" class="form-control" id="ukuran">
                                                </div>
                                                <div class="form-group">
                                                    <label for="harga">Harga<span class="text-danger">*</span></label>
                                                    <input name="harga" readonly="" value="{{$detail->harga}}" autocomplete="off"     type="number" placeholder="Masukan Stok" name" class="form-control" id="harga">
                                                </div>
