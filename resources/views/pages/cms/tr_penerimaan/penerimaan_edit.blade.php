                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Master Penerimaan</h4>
                            ...
                            <div class="col-sm-12 col-xs-12 col-md-12">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                            <input type="text" autocomplete="off" class="form-control" name="nama_penerima" value="{{$order->nama_penerima}}" id="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <div class="input-group">
                                                            <input required="" type="text" autocomplete="off" ="" class="form-control" name="tgl_terima" placeholder="yyyy-mm-dd" value="{{$order->tgl_terima}}" id="tgl_terima">
                                                            <span class="input-group-addon bg-custom b-0"><i class="icon-calender"></i></span>
                                                        </div><!-- input-group -->
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group text-right m-b-0">
                                                    ...
                                                    <a href="{{url('/penerimaan')}}" class="width50 btn btn-secondary m-l-5">
                                                        Batal
                                                    </a>
                                                </div>
