                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="card-box">
                                                ...
                                                @endif
                                                <form method="POST" action="{{url('/outlet/input')}}" data-parsley-validate novalidate>
                                                    {{ csrf_field() }}
                                        ...
                                        <div class="col-sm-12 col-xs-12 col-md-6">
                                            ...
                                            <div class="p-20">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="outlet_name"  required  value="{{ old('outlet_name') }}" placeholder="Nama Outlet" name" class="form-control" id="outlet_name">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="phone_number"  required  value="{{ old('phone_number') }}" data-parsley-type="number" type="text" data-parsley-minlength="9" placeholder="Enter only number" name" class="form-control" id="phone_number">
                                                </div>
                                                <div class="form-group">
