                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="card-box">
                                                ...
                                                @endif
                                                <form method="POST" action="{{url('/usergroup/input')}}" data-parsley-validate novalidate>
                                                {{ csrf_field() }}
                                        ...
                                        <div class="col-sm-12 col-xs-12 col-md-6">
                                            ...
                                            <div class="p-20">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title"  required  value="{{ old('title') }}" placeholder="Nama Usergroup" name" class="form-control" id="title">
                                                </div>
                                                <div class="form-group">
                                                    <label for="description">Deskripsi</label>
                                                    <textarea required class="form-control" id="summernote" name="description">{{ old('outlet_name') }}</textarea>
                                                </div>
                                            </div>
