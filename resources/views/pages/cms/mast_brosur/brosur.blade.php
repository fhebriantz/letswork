                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <a href="{{url('brosur/input')}}" class="btn btn-info m-b-20">Tambah</a>
                                        ...
                                        <tbody>             
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {{ csrf_field() }}
                                                    <button class="btn btn-action marginright btn-trash-list" type="submit" name="delete" onclick="return confirm('Are you sure want to delete name {{$brosur->nama_dokter}}?');"><img class="trash-list" src="{{ asset('images/icon/trash.png')}}" alt=""></button> 
