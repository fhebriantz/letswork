...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 29, 2019 at 12:47 PM
...
INSERT INTO `lw_detail_trans_order` (`id`, `id_trans_order`, `kemasan`, `ukuran`, `qty`, `harga`, `total_harga`, `created_date`, `created_by`, `modified_date`, `modified_by`) VALUES
...
--
-- Table structure for table `lw_hist_pembayaran`
--

CREATE TABLE `lw_hist_pembayaran` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `lw_hist_pembayaran`
--

INSERT INTO `lw_hist_pembayaran` (`id`, `id_trans_order`, `jumlah`, `penerima`, `pemberi`, `waktu_pembayaran`, `created_date`, `created_by`, `modified_date`, `modified_by`) VALUES
...
(37, 1548737663, 1, 1, 2, 1, '2019-01-21', 1, '2019-01-16', '2019-01-29 03:54:27', '2', '2019-01-29 03:55:36', '2', 1),
(38, 1548750977, 1, 1, 1, NULL, NULL, NULL, '2019-01-22', '2019-01-29 07:36:23', '2', '2019-01-29 07:36:38', '2', 1),
(39, 1548754121, 2, 1, 1, NULL, NULL, NULL, '2019-01-14', '2019-01-29 09:35:48', '2', '2019-01-29 09:35:48', NULL, 0),
(40, 1548758848, 1, 1, 1, NULL, NULL, NULL, '2019-01-22', '2019-01-29 09:47:34', '2', '2019-01-29 09:47:34', NULL, 0),
(41, 1548758949, 1, 2, 1, NULL, NULL, NULL, '2019-01-15', '2019-01-29 09:49:14', '2', '2019-01-29 09:49:14', NULL, 0),
(42, 1548758949, 1, 2, 1, NULL, NULL, NULL, '2019-01-15', '2019-01-29 09:51:05', '2', '2019-01-29 09:51:05', NULL, 0),
(43, 1548759078, 1, 1, 1, NULL, NULL, NULL, '2019-01-22', '2019-01-29 09:51:22', '2', '2019-01-29 09:51:22', NULL, 0),
(44, 1548759078, 1, 1, 1, NULL, NULL, NULL, '2019-01-22', '2019-01-29 09:51:36', '2', '2019-01-29 09:51:36', NULL, 0),
(45, 1548759853, 1, 1, 1, NULL, NULL, NULL, '2019-01-22', '2019-01-29 10:04:19', '2', '2019-01-29 10:04:19', NULL, 0);
...
--
-- Indexes for table `lw_hist_pembayaran`
--
ALTER TABLE `lw_hist_pembayaran`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `lw_hist_pembayaran`
--
ALTER TABLE `lw_hist_pembayaran`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
